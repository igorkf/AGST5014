...
Using a significance level of $\alpha = 0.05$, we conclude that both treatments are significant. The interaction interaction is also significant, as we suspected from the interaction plot.    
